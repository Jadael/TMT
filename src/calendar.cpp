...
struct Calendar : Module {
	...
	Calendar() {
		...
		configOutput(SECOND_STEPPED_OUTPUT, "1 second stepped ramp, 2 steps");
		...
		configOutput(MINUTE_TRIGGER_OUTPUT, "1 minute gate (high on first half)");
		configOutput(MINUTE_GATE_OUTPUT, "1 minute gate (high on second half)");
		configOutput(MINUTE_IGATE_OUTPUT, "1 minute inverted gate (high during first half)");
